...
export async function writeJSON(path: string, content: {[key: string]: any}, indent = 2) {
...
export async function readJSON<T extends {[key: string]: any}>(path: string): Promise<T> {
